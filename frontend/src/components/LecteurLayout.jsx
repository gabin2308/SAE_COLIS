...
const navItems = [
  { to: "/lecteur",               icon: "📦", label: "Mes colis",       end: true },
  { to: "/lecteur/demandes",      icon: "📝", label: "Mes demandes" },
  { to: "/lecteur/notifications", icon: "🔔", label: "Notifications" },
]

export default function LecteurLayout() {
