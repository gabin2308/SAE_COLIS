...
class BonCommandeController:
    ...
    # @login_required supprimé car @reqrole gère déjà l'authentification
    ...
    def create(self):
        ...
        try:
            # Conversion sécurisée de l'identité JWT
            bc = self.bcs.create(
            ...
            logging.error(f"Erreur création bon de commande: {e}")
    ...
    def delete(self, id_bon_commande):
        try:
            ...
            logging.error(f"Erreur suppression bon de commande: {e}")
            return jsonify({"error": "Erreur serveur interne"}), 500
