...
class ColisController:
    ...
    def _register_routes(self):
        ...
        self.blueprint.add_url_rule('/scan/<string:qr_payload>', view_func=self.scanQR, methods=['GET'])
    ...
    def create(self):
        ...
        if not data.get('bon_commande_id'):
        ...
        try:
            colis = self.cs.create(
                ...
                statut_libelle=data.get('statut_libelle', 'recu_universite'),
            ...
            logging.error(f"Erreur création colis: {e}")
